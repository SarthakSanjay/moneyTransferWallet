...
const Account = ({showProfile , user ,setSelected}) => {
  ...
  return (
    <div className={` ${showProfile? 'h-1/2 w-1/2 md:w-1/4 p-4 ':'w-0 h-0 p-0'} transition-all duration-500 ease-in-out  absolute top-24 right-0 mx-2 rounded-lg  text-white bg-blue-900/80 dark:bg-emerald-800/80
